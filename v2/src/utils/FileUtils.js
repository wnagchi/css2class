...
class FileUtils {
  ...
  getRelativePath(fromPath, toPath) {
    try {
      ...
      this.eventBus.emit('fileUtils:error', { operation: 'getRelativePath', fromPath, toPath, error });
      return toPath;
    }
  }
  ...
  getAbsolutePath(filePath, basePath = process.cwd()) {
    try {
      ...
      this.eventBus.emit('fileUtils:error', { operation: 'getAbsolutePath', filePath, basePath, error });
      return filePath;
    }
  }

class RegexCompiler {
  ...
  testClassAttribute(text) {
    ...
    const testRegex = new RegExp(this.compiledRegex.classAttr.source, this.compiledRegex.classAttr.flags);
  ...
  matchClassAttributes(htmlStr) {
    ...
    const matches = [];
    let match;
    const regex = new RegExp(this.compiledRegex.classAttr.source, this.compiledRegex.classAttr.flags);
  ...
  matchClassNames(classStr) {
    ...
    const matches = [];
    let match;
    const regex = new RegExp(this.compiledRegex.classNames.source, this.compiledRegex.classNames.flags);

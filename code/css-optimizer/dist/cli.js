...
exports.CSSOptimizerCLI = void 0;
const commander_1 = require("commander");
const path = __importStar(require("path"));
const fs = __importStar(require("fs-extra"));
const css_optimizer_1 = require("./css-optimizer");
/**
 * CLI主程序
 */
class CSSOptimizerCLI {
    constructor() {
        ...
        this.optimizer = new css_optimizer_1.CSSOptimizer();
        this.setupCLI();
    }
    /**
     * 设置CLI命令
...
`;
    ...
    async createPackageJson(projectPath, projectName) {
        ...
        await fs.writeFile(path.join(projectPath, 'package.json'), JSON.stringify(packageJson, null, 2), 'utf-8');
    }
    /**
     * 格式化字节数
     */
...
exports.CSSOptimizerCLI = CSSOptimizerCLI;
// 运行CLI

...
用法:
  node test.js <文件或目录路径> [输出文件]

示例:
  node test.js examples/comprehensive-example.vue
  node test.js examples/ output.css
  node test.js examples/comprehensive-example.vue examples/miniprogram-example.wxml
    `);
    return;
  }
